...
class mqttDCI:
    ...
    def work(self, wait_between_new_pieces = 20, queueToTS = None):
        """
        ...
        for i in range(1,4):
            if self.check_magazine_empty(i):
        ...
        #================================== MQTT ==================================
        threading.Thread(target=self.work_output_piece_end).start()
        #================================== MQTT ==================================
        ...
        client = mqtt.Client()
        conveyor_topic = "Transport_Ingoing/Conveyor_A/Moving"
        switch_topic = "Transport_Ingoing/Switch_W/Status"
        client.connect("192.168.200.161", 1883)
        client.subscribe(conveyor_topic)
        ...
        while on_message:
            ...
            if rand in [0,1,2]:
                ...
                #================================== MQTT ==================================
                    ...
                    publish.single("input2/mag"+str(rand+1), "empty", hostname="192.168.200.161")
                #================================== MQTT ==================================
